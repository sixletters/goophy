...
// this sets enum numbers. blank identifier takes 0 as value
// This helps us to check the precedence of the operator
...
func (p *Parser) parseForStatement() *ast.ForStatement {
	...
	stmt.ForBlock = p.parseBlockStatement()
	return stmt
...
func (p *Parser) parseIfExpression() ast.Expression {
	...
	expression.IfBlock = p.parseBlockStatement()
